...
class Test_Subash:
    ...
    def test_edit(self, boot):
        ...
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().pencil_icon).click()
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().nick_name).send_keys(Subash_Data().nickname)
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().license_number).send_keys(Subash_Data().licensenumber)
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().military_service).send_keys(Subash_Data().militaryservice)
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().save_button).click()
        print("Sucessful Empolyee Details Addition")
        while(True):
            pass
