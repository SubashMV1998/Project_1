...
class Test_Subash:
    ...
    def test_employee_login(self, boot):
        ...
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().check_input_box_icon).click()
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().trash_icon).click()
        self.driver.find_element(by=By.XPATH, value=Subash_Locators().delete_icon).click()
        print("Empolyee Details Deleted Successfully")
        while(True):
            pass
